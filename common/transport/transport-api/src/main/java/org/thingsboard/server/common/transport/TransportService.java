...
public interface TransportService {
    ...
    void myProcess(DeviceTransportType transportType, ValidateDeviceTokenRequestMsg msg,
    ...
    void myProcess(SessionInfoProto sessionInfo, PostTelemetryMsg msg, TransportServiceCallback<Void> callback, Map<String, String> map);
